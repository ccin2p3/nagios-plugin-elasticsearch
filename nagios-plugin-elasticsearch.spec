...
%define srcname nagios-plugin-elasticsearch
...
%files
%{_bindir}/check_elasticsearch
%{python2_sitelib}/nagios_plugin_elasticsearch-%{version}-py2.*.egg-info

%if 0%{?with_python3}
%files -n python3-%{project}
%{_bindir}/check_elasticsearch
%{python3_sitelib}/nagios_plugin_elasticsearch-%{version}-py3.*.egg-info
%endif # with_python3

%changelog
* Tue Jan 22 2019 Peter Adam <p.adam@cygnusnetworks.de> 1.0.3-1
